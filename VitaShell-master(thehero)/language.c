...
void loadLanguage(int id) {
  ...
  ConfigEntry language_entries[] = {
    ...
    LANGUAGE_ENTRY(OPERATION_COMPLETED),
    LANGUAGE_ENTRY(FILE_COPIED_TO_CLIPBOARD),
    LANGUAGE_ENTRY(PROCESSING_FILE),
    LANGUAGE_ENTRY(PROCESSING_DIRECTORY),

    // Dialog questions
    LANGUAGE_ENTRY(DELETE_FILE_QUESTION),
    LANGUAGE_ENTRY(DELETE_FOLDER_QUESTION),
    LANGUAGE_ENTRY(DELETE_FILES_FOLDERS_QUESTION),
    LANGUAGE_ENTRY(DELETE_IMPORTANT_FILE_QUESTION),
    ...
    LANGUAGE_ENTRY(INSTALL_COMPLETE_SUCCESS),
  ...
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_LOW_BATTERY_WARNING),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_AUDIO_REPEAT),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_AUDIO_REPEAT_SHUFFLE),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_CHECK_UPDATES),
  ...
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_BATTERY_INFO),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_USB_MEMORY_CARD),
    ...
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR),
  ...
  LANGUAGE_ENTRY(CHECKING_UPDATES),
  LANGUAGE_ENTRY(ARCHIVE_NAME),
    LANGUAGE_ENTRY(COMPRESSION_LEVEL),
    LANGUAGE_ENTRY(ENTER_PASSWORD),
  LANGUAGE_ENTRY(BOOKMARK_CREATED),
  LANGUAGE_ENTRY(SHORTCUTS_INFO),
  LANGUAGE_ENTRY(LANGUAGE_CHANGED_RESTART_MSG),
  LANGUAGE_ENTRY(RUN_APP_AFTER_INSTALL),
  LANGUAGE_ENTRY(LAUNCH_APP_GAME),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_DEFAULT),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_LIGHT_GREY),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_BLUE),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_RED),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_PINK),

  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_YELLOW),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_WHITE),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FOCUS_COLOR_RAINBOW),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FONT_SIZE),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_ENABLE_TOUCH),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FONT_SIZE_SMALL),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FONT_SIZE_NORMAL),
  LANGUAGE_ENTRY(VITASHELL_SETTINGS_FONT_SIZE_LARGE),

  LANGUAGE_ENTRY(NO_UPDATES_AVAILABLE)
  };
