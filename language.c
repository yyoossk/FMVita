...
void loadLanguage(int id) {
  ...
  ConfigEntry language_entries[] = {
    ...
    LANGUAGE_ENTRY(UNDO_ACTION),

    // Custom toolbar strings
    LANGUAGE_ENTRY(FILTER_ALL),
    LANGUAGE_ENTRY(FILTER_FOLDERS),
    LANGUAGE_ENTRY(FILTER_FILES),
    LANGUAGE_ENTRY(FILTER),
    LANGUAGE_ENTRY(GROUP),
    LANGUAGE_ENTRY(CONFIRM_YES_BTN),
    LANGUAGE_ENTRY(CONFIRM_NO_BTN),
    LANGUAGE_ENTRY(FTP_CONNECT_LABEL),
    LANGUAGE_ENTRY(FTP_STOP_LABEL),
    LANGUAGE_ENTRY(FTP_SERVER_TITLE),
    ...
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_REAR_TOUCH),
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_VIEW_MODE),
    ...
    LANGUAGE_ENTRY(COPY_BTN),
    LANGUAGE_ENTRY(DELETE_BTN),
    LANGUAGE_ENTRY(SAVE_BTN),
    LANGUAGE_ENTRY(MIRROR_BTN),
    LANGUAGE_ENTRY(MIRRORED_LABEL),
    ...
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_SELECT_BUTTON_QR),
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_BG_ANIM),
    LANGUAGE_ENTRY(BG_ANIM_PARTICLES),
    LANGUAGE_ENTRY(BG_ANIM_WAVES),
    LANGUAGE_ENTRY(BG_ANIM_STARS),
    LANGUAGE_ENTRY(BG_ANIM_SQUARES),
    LANGUAGE_ENTRY(BG_ANIM_SPARK),
   LANGUAGE_ENTRY(BG_ANIM_MATRIX),
   LANGUAGE_ENTRY(BG_ANIM_RAIN),
   LANGUAGE_ENTRY(BG_ANIM_GIF),
    LANGUAGE_ENTRY(BG_ANIM_PNG),
    LANGUAGE_ENTRY(VIEW_MODE_LIST),
    LANGUAGE_ENTRY(VIEW_MODE_GRID),
    LANGUAGE_ENTRY(VIEW_MODE_2COLUMN),
    LANGUAGE_ENTRY(VIEW_MODE_3COLUMN),
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_THEME_PRESET),
    LANGUAGE_ENTRY(THEME_DARK),
    LANGUAGE_ENTRY(THEME_LIGHT),
    LANGUAGE_ENTRY(THEME_BLUE),
    LANGUAGE_ENTRY(THEME_RED),
    LANGUAGE_ENTRY(THEME_PURPLE),
    LANGUAGE_ENTRY(THEME_BROWN),
    LANGUAGE_ENTRY(THEME_GRAY),
    LANGUAGE_ENTRY(THEME_CUSTOM),
   ...
   LANGUAGE_ENTRY(ITEMS),
   LANGUAGE_ENTRY(NAV_BACK),
   LANGUAGE_ENTRY(NAV_OPEN),
   LANGUAGE_ENTRY(CLOSE_LABEL),
   LANGUAGE_ENTRY(CONFIRM_REBOOT),
   LANGUAGE_ENTRY(CONFIRM_RESTART),
   LANGUAGE_ENTRY(CONFIRM_POWEROFF),
   LANGUAGE_ENTRY(CONFIRM_STANDBY),

   LANGUAGE_ENTRY(VIDEO_CONTROLS),
