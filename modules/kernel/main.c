...
int shellKernelIsUx0Redirected(const char *blkdev, const char *blkdev2) {
  ...
  ksceKernelStrncpyUserToKernel(k_blkdev, (void *)(uintptr_t)blkdev, sizeof(k_blkdev)-1);
  ksceKernelStrncpyUserToKernel(k_blkdev2, (void *)(uintptr_t)blkdev2, sizeof(k_blkdev2)-1);
...
int shellKernelRedirectUx0(const char *blkdev, const char *blkdev2) {
  ...
  ksceKernelStrncpyUserToKernel(ux0_blkdev, (void *)(uintptr_t)blkdev, sizeof(ux0_blkdev)-1);
  ksceKernelStrncpyUserToKernel(ux0_blkdev2, (void *)(uintptr_t)blkdev2, sizeof(ux0_blkdev2)-1);
...
int _shellKernelMountById(ShellMountIdArgs *args) {
  ...
  if (args->process_titleid)
    ksceKernelStrncpyUserToKernel(process_titleid, (void *)(uintptr_t)args->process_titleid, 11);
  if (args->path)
    ksceKernelStrncpyUserToKernel(path, (void *)(uintptr_t)args->path, 255);
  if (args->desired_mount_point)
    ksceKernelStrncpyUserToKernel(desired_mount_point, (void *)(uintptr_t)args->desired_mount_point, 15);
  if (args->klicensee)
    ksceKernelMemcpyUserToKernel(klicensee, (void *)(uintptr_t)args->klicensee, 0x10);
  ...
  if (args->mount_point)
    ksceKernelStrncpyKernelToUser((void *)(uintptr_t)args->mount_point, mount_point, 15);
...
int shellKernelMountById(ShellMountIdArgs *args) {
  ...
  ksceKernelMemcpyUserToKernel(&k_args, (void *)(uintptr_t)args, sizeof(ShellMountIdArgs));
...
int shellKernelGetRifVitaKey(const void *license_buf, void *klicensee) {
  ...
  if (license_buf)
    ksceKernelMemcpyUserToKernel(k_license_buf, (void *)(uintptr_t)license_buf, sizeof(k_license_buf));

  int res = ksceNpDrmGetRifVitaKey(k_license_buf, (uint8_t *)k_klicensee, NULL, NULL, NULL, NULL);

  if (klicensee)
    ksceKernelMemcpyKernelToUser((void *)(uintptr_t)klicensee, k_klicensee, sizeof(k_klicensee));
...
int module_start(SceSize args, void *argp) {
  ...
  // Load SceUsbMass
  SceUID modid = ksceKernelLoadStartModule("ux0:FMVita/module/umass.skprx", 0, NULL, 0, NULL, NULL);
